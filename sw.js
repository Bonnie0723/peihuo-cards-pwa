const CACHE = "peihuo-miao-v7";
const APP_SHELL = ["./", "./index.html", "./styles.css?v=7", "./theme.css", "./app.js?v=7", "./app-icon.png", "./mascot-kitty.png", "./icon-order.png", "./icon-stall.png", "./icon-card.png", "./manifest.webmanifest"];
