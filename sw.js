const CACHE = "peihuo-miao-v8";
const APP_SHELL = ["./", "./index.html", "./styles.css?v=7", "./theme.css", "./app.js?v=8", "./stall-parser.js?v=8", "./app-icon.png", "./mascot-kitty.png", "./icon-order.png", "./icon-stall.png", "./icon-card.png", "./manifest.webmanifest"];
